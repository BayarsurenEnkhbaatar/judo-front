...
const Round3Card = ({data}) => {
  return (
    <div className='border-t border-b border-r border-gray-300 p-1 h-full flex justify-between flex-col xs:w-20 md:w-48 mt-1 font-Roboto xs:text-xs md:text-sm'>
        <div>
            {
